...
<div class="container" id="additional">
	<button class="btn" id="recordpatient"><a href="Records.html">Profile</a></button>
	<button class="btn" id="backpatient"><a href="Viewpatient.html">Back</a></button>
</div>
</center>

<center>
<div class="container" id="recordcontent">
