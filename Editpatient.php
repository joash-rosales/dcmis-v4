...
<div class="container" id="additional">
	<button class="btn" id="savepatient"><a href="Viewpatient.html">Save</a></button>
	<button class="btn" id="backpatient"><a href="Viewpatient.html">Cancel</a></button>
...
<div class="container" id="addpatcontent">
	<div class="row">
	  	...
	  	<div class="col-md-3">
	    	<div class="thumbnail">
	      		<img src="images/11.jpg" alt="Add Photo" id="image">
	      			<div class="caption">
	        			<p><a href="#" class="btn btn-default" id="photo" role="button">Change</a></p>
	        			<p><a href="#" class="btn btn-default" id="photo2" role="button">Remove</a></p>
	      			</div>
	    	</div>
	  	</div>
	  	...
	  	<div class="col-md-9">
	  		<div class="container" id="coninput">
		    	<div id="input">
		    		...
		    		<input type="text" id="name" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="add1" for="add">Address:</label>
		    		<input type="text" id="add" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="tell1" for="tell">Telephone:</label>
		    		<input type="text" id="tell" class="form-control" value="blank">
		    	</div>
	    	</div>
	    	...
	    	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="age" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="sex1" for="sex">Sex:</label>
		    		<input type="text" id="sex" class="form-control dropdown-toggle" data-toggle="dropdown" role="button" value="blank">
		    	...
		    	<div id="input">
		    		...
		    		<input type="text" id="ms" class="form-control dropdown-toggle" data-toggle="dropdown" role="button" value="blank">
							<ul class="dropdown-menu" role="menu">
		    	...
		    	<div id="input">
		    		...
		    		<input type="text" id="occu" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="cell1" for="cell">Cellphone:</label>
		    		<input type="text" id="cell" class="form-control" value="blank">
		    	</div>
	    	</div>
	    	...
	    	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="oa" class="form-control" value="blank">
		    	</div>
	    	...
	    	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="com" class="form-control" value="blank">
		    	</div>
	    	</div>
	  	...
	  	<div class="col-md-4">
	    	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="oh" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="pc1" for="pc">Periodontal Condition:</label>
		    		<input type="text" id="pc" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	...
		    	<div id="input">
		    		...
		    		<input type="text" id="up" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="since1" for="since">Since:</label>
		    		<input type="text" id="since" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	...
		    	<div id="input">
		    		...
		    		<input type="text" id="low" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="since2" for="sinced">Since:</label>
		    		<input type="text" id="sinced" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="an" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="gen1" for="gen">General Conditions:</label>
		    		<input type="text" id="gen" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="phy" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="not1" for="not">Nature of treatment:</label>
		    		<input type="text" id="not" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="all" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="hob1" for="hob">History of bleeding:</label>
		    		<input type="text" id="hob" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="ca" class="form-control" value="blank">
		    	</div>

		    	<div id="input">
		      		<label id="bp1" for="bp">Blood Pressure:</label>
		    		<input type="text" id="bp" class="form-control" value="blank">
		    	</div>
		  	</div>
		  	...
		  	<div class="container" id="coninput2">
		    	<div id="input">
		    		...
		    		<input type="text" id="dbt" class="form-control" value="blank">
		    	</div>
		  	</div>
